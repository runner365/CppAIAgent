...
//#endif
        ...
        SSL_set_tlsext_host_name(ssl_, "dashscope.aliyuncs.com"); // 替换为目标域名
    ...
    int HandleSslDataRecv(uint8_t* data, size_t len) {
        ...
        r1 = SSL_get_error(ssl_, r0);
        r2 = (int)BIO_ctrl_pending(bio_in_);
        ...
        r0 = BIO_write(bio_in_, data, (int)len);
        if (r0 <= 0) {
